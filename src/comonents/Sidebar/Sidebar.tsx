...
import IconDeposti from "../SvgIcons/IconDeposti"
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-2 lg:py-2.5">
        <NavLink to="/dashboard">
          <h1 className="text-3xl font-semibold text-black">Web 320</h1>
        </NavLink>
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <NavLink
                  to="/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 text-base px-4 font-medium text-[#5734DC]  duration-300 ease-in-out hover:bg-[#EFEBFE] dark:hover:bg-meta-4 ${
                    (pathname === "/" || pathname.includes("dashboard")) &&
                    "bg-[#EFEBFE] dark:bg-meta-4"
                  }'
                    }`}
                >
